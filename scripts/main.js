  ...
  if(this.keyboard.keys.enter) {
    for(var i = 0; i < this.monsters.length; i++) {
      this.tween(this.monsters[i])
        .delay(i + 0.5)
        .to({x: map[9][1].x + 15, y: map[9][1].y + 15},1)
        .to({x: map[8][1].x + 15, y: map[8][1].y + 15},1)
        .to({x: map[7][1].x + 15, y: map[7][1].y + 15},1)
        .to({x: map[6][1].x + 15, y: map[6][1].y + 15},1)
        .to({x: map[5][1].x + 15, y: map[5][1].y + 15},1)
        .to({x: map[4][1].x + 15, y: map[4][1].y + 15},1)
        .to({x: map[3][1].x + 15, y: map[3][1].y + 15},1)
        .to({x: map[2][1].x + 15, y: map[2][1].y + 15},1)
        .to({x: map[1][1].x + 15, y: map[1][1].y + 15},1)
        .to({x: map[1][2].x + 15, y: map[1][2].y + 15},1)
        .to({x: map[1][3].x + 15, y: map[1][3].y + 15},1)
        .to({x: map[2][3].x + 15, y: map[2][3].y + 15},1)
        .to({x: map[3][3].x + 15, y: map[3][3].y + 15},1)
        .to({x: map[4][3].x + 15, y: map[5][3].y + 15},1)
        .to({x: map[5][3].x + 15, y: map[6][3].y + 15},1)
        .to({x: map[6][3].x + 15, y: map[6][3].y + 15},1)
        .to({x: map[7][3].x + 15, y: map[7][3].y + 15},1)
        .to({x: map[8][3].x + 15, y: map[8][3].y + 15},1)
        .to({x: map[9][3].x + 15, y: map[9][3].y + 15},1)
        .to({x: map[9][4].x + 15, y: map[9][4].y + 15},1)
        .to({x: map[9][5].x + 15, y: map[9][5].y + 15},1)
        .to({x: map[8][5].x + 15, y: map[8][5].y + 15},1)
    }
  }
}
